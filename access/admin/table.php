...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block side">
        ...
        <ul class="list-group">
            ...
            <a href="table" class="bg-light list-group-item list-group-item-action active">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <div class="col p-4">
        ...
        <div class="form-row">
            ...
            <div class="col-2"> 
                         <a style="margin-top: 5px;float: right;" class="btn btn-warning add_button button" data-toggle="modal" data-target="#AddModal" data-toggle='tooltip' data-placement='top' title='Add Table'><i class="fas fa-plus"></i> Table
                     </a>
            </div>
        </div>
                <div class="form-row">
          ...
          <div class="col-md-12">
                ...
                <?php
                  ...
                  // loop through the user records
                      $stmt = $user->all_table_view($search_term, $from_record_num, $records_per_page);
                      $page_url="table?s={$search_term}&";
                      $total_rows=$user->all_table_count($search_term);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Archive Table</h5>
...
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="AddModalLabel" aria-hidden="true">
  ...
  <tbody>
   ...
   <tr>
        <td> <label for='table_name'>Table Number</label></td>
        <td><input type='text' class='form-control'  name='table_number' required=""></td>
...
<div class="modal fade" id="updateModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Edit Table</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
