...
<div class="row" id="body-row">
    ...
    <div class="col p-4">
        ...
        <div class="form-row">
            ...
            <div class="col-2"> 
                         <a style="margin-top: 5px;float: right;" class="btn btn-warning add_button button" data-toggle="modal" data-target="#AddModal" data-toggle='tooltip' data-placement='top' title='Add Category'><i class="fas fa-plus"></i> Category
                     </a>
            </div>
        </div>
                <div class="form-row">
          ...
          <div class="col-md-12">
                ...
                <?php
                  ...
                  // loop through the user records
                      $stmt = $user->all_category_view($search_term, $from_record_num, $records_per_page);
                      $page_url="menu?s={$search_term}&";
                      $total_rows=$user->all_category_count($search_term);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Archive Category</h5>
...
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="AddModalLabel" aria-hidden="true">
  ...
  <tr>
        ...
        <td><textarea class="form-control" name="category_description" rows="3" required=""></textarea></td>
       
    </tr>

      <tr>
        <td> <label for='category_type'>Category Type</label></td>
        <td> <Select class="form-control" name="category_type" required>
    ...
    <tr>
            ...
            <td>
              ...
              <button type='submit' class='btn btn-secondary' style='float: right;' >Add</button>
...
<div class="modal fade" id="updateModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Edit Category</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
function SidebarCollapse () {
  ...
  $.ajax({  
    ...
    console.log(edit_id, pass);

    $.ajax({
        url: 'edit_category.php',
        method: 'POST',
        data:{edit_id:edit_id, pass:pass},
