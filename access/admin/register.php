...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block side">
        ...
        <ul class="list-group">
            ...
            <a href="register" class="bg-light list-group-item list-group-item-action active">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <div  class="form">
        <div class="wrapper" style="margin: 0 auto;">
           <center><p>Please fill in credentials to register account.</p></center>
           <br>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              <div class="form-row">
                ...
                <p style="font-size: 12px; font-family: Arial;"><i>(Create a strong password to secure account)</i></p>
                 ...
                 <div class="form-row">
                  <div class="col-md-6">
                  <label for="office">*User Type</label>
