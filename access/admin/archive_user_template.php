        ...
        extract($row);
          ...
          echo "<td>";  
               ...
               echo "
                  ...
                  <a class='btn btn-outline-danger delete_object button_size' delete_id='".$user_id."'><i class='fas fa-trash'></i> Delete </a>
                  <a class='btn btn-outline-secondary activate_object button_size' activate_id='".$user_id."'><i class='fas fa-toggle-on'></i> Activate
                       </a> 
