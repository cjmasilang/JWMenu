          ...
          <div class="col-md-12">
                ...
                <?php
                  ...
                  // loop through the user records
                      $stmt = $user->all_food_list_view_archive($search_term, $from_record_num, $records_per_page);
                      $page_url="archive_menu_list?s={$search_term}";
                      $total_rows=$user->all_food_list_count_archive($search_term);

                     include_once "archive_food_template.php";
              ?>
              </div>
          </div>
...
<div class="modal fade" id="updateModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Activate Food Item</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
