  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active" style="margin-right: 5px; margin-bottom: 5px; margin-left: 5px;">
        <a class="nav-link btn btn-warning " href="menu?i=<?php echo $t_id;?>">All Menu View</a>
      </li>
    </ul>
...
<br>
<div class="form-row">
  <div class="col-md-2" style="margin-bottom: 5px;"><a class="nav-link btn btn-outline-warning " href="category?i=<?php echo $t_id;?>">Category View</a></div>
  <div class="col-md-2" style="margin-bottom: 5px;"><a class="nav-link btn btn-warning " href="menu?i=<?php echo $t_id;?>">All Menu View</a></div>
  <div class="col-md-4" style="margin-bottom: 5px;">   </div>
  <div class="col-md-4" style="margin-bottom: 5px;"> <?php
   
    echo "
    <form action='menu?i=".$t_id."' method='POST'>
    <div class='input-group mb-4' >
  <div class='form-outline'>";
      
        $search_value=isset($search_term) ? "value='{$search_term}'" : "";
      echo'
      <input class="form-control" type="text"  aria-label="Search" name="s" id="srch-term" {$search_value}/>
      </div>
