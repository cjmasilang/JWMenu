...
<div class="form-row">
  ...
  <button style="margin-right: 5px; margin-bottom: 5px; margin-left: 5px;" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        <a style="margin-right: 5px; margin-bottom: 5px; margin-left: 5px;" class="nav-link btn btn-outline-warning " href="menu?i=<?php echo $t_id;?>">All Menu View</a>
      </li>
    </ul>
