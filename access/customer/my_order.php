...
<?php include_once "navigation.php";
 ...
 $t_id = isset($_GET['table']) ? $_GET['table'] : die('ERROR: missing ID.');
   $user->table_id = $t_id;
...
<div class="form-row">
  ...
  <a style="font-size: 0.9rem;" href="home?i=<?php echo $t_id;?>" class="navbar-brand"><i class="fas fa-arrow-circle-left"></i> Food Category</a>
    <a ></a>
