...
<div class="row" id="body-row">
    ...
    <div class="col p-4">    
   <?php
 $table_id = isset($_GET['table']) ? $_GET['table'] : die('<div class="alert alert-warning" role="alert">
...
<div class="form-row">
  ...
  <a style="font-size: 0.9rem;" href="menu_view?table=<?php echo $table_id;?>" class="navbar-brand"></a>
    <a style="color: black;" href="my_order?table=<?php echo $table_id;?>" class="btn btn-warning my-2 my-sm-0" type="submit"><i class="fas fa-shopping-cart"></i> My Order</a>
...
<hr>
        ...
        extract($row2);
             echo '   <div class="column">
                    <article class="card">
                      <div>
                        <h2><a style="text-decoration:none; color: black;" href="../../access/employee/category_view?category='.$category_id.'&table='.$table_id.'" class="main-link" >'.$category_name.'</a></h2>
                        <p>
