...
<hr>
        ...
        extract($row2);
             echo '   <div class="column">
                    <article class="card">
                      <div>
                        <h2><a style="text-decoration:none; color: black;" href="../../access/employee/take_out_category_view?category='.$category_id.'&t='.$t_id.'" class="main-link" >'.$category_name.'</a></h2>
                        <p class="til">
