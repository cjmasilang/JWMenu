...
<div class="row" id="body-row">
 ...
 $order_id = isset($_GET['order']) ? $_GET['order'] : die('ERROR: missing ID.');
  $user->table_id =  $table_id;
  $user->category_id =  $category_id;
  $user->transaction_number =  $order_id;
...
<div class="form-row">
  ...
  <a style="font-size: 0.9rem;" href="menu_view_add?table=<?php echo $order_id;?>" class="navbar-brand"><i class="fas fa-arrow-circle-left"></i> Food Category</a>
    <a style="color: black;" href="my_order_add?table=<?php echo $order_id;?>" class="btn btn-warning my-2 my-sm-0" type="submit"><i class="fas fa-shopping-cart"></i> My Order</a>
...
<hr>
        ...
        extract($row2);
             ...
             echo '   <div class="column">
                    <article class="card view_object" view_id="'.$food_id.'" table_id="'.$order_id.'" data-toggle="tooltip" data-placement="top" title="View">
                      <div>
                           ';
