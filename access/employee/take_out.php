  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item " style="margin-right: 5px;">
        <a class="nav-link btn btn-outline-warning " href="take_out_category?t=<?php echo $t_id;?>">Category View</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link btn btn-warning " href="take_out?t=<?php echo $t_id;?>">All Menu View</a>
      </li>
    </ul>
    <?php
   
    echo "
    <form class='form-inline my-2 my-lg-0' action='take_out?t=Take-out' method='POST'>";
