        ...
        extract($row2);
             echo '   <div class="column">';
              ...
              if($table_status == 'Occupied'){
                      ...
                      <div>
                        <h2><p style="text-decoration:none; color: black;" href="../../access/employee/menu_view?table='.$table_id.'"  class="main-link" >'.$table_number.'</p></h2>
                        <p style="color:red;">
                      ...
                      echo'<article class="card">
                      <div>
                        <h2><a style="text-decoration:none; color: black;" href="../../access/employee/menu_view?table='.$table_id.'" class="main-link" >'.$table_number.'</a></h2>
                        <p style="color:green; padding-top:8px;" >
                          This table is available. 
                        </p>
                          <img src="../../images/table.png" alt="table" style="width:100%; max-height:180px;">
                      </div>
                    </article>';
              }
