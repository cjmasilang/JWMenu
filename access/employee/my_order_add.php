...
<div class="row" id="body-row">
 ...
 $table_id = isset($_GET['table']) ? $_GET['table'] : die('ERROR: missing ID.');
   $user->transac_id =  $table_id;
   $tran_number = $table_id;
   $table = $table_id;
     $stmt= $user->select_table_add();
...
<div class="form-row">
  ...
  <a style="font-size: 0.9rem;" href="menu_view_add?table=<?php echo $table;?>" class="navbar-brand"><i class="fas fa-arrow-circle-left"></i> Food Category</a>
    <a ></a>
...
if (isset($_POST["submit"])) {
  ...
  $pusher2 = new Pusher\Pusher(
    ...
    $transaction_total_price = $_POST["transaction_total_price"]; 
      $user->tran_id = $tran_number;
    if($user->update_transaction_order_add() && $user->update_transaction_add() && $user->update_transaction_order_add_on_add()){
  ...
  $data2['message'] = $transaction_total_price;
...
<div class="form-row">
  ...
  <div class="col-md-12">
                  ...
                  // loop through the order records
                     ...
                     $total_price=$user->total_price_add();
              ?>
