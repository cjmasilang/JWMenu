...
if (isset($_GET["table"])) {
    $t_id = $_GET["table"];   
   $user->table_id = $t_id;
      $stmt= $user->take_out_checker();
      $row = $stmt->fetch(PDO::FETCH_ASSOC);
        if($row){
        extract($row);
        
        if($table_number == "Temporary"){

                      $stmt2= $user->view_table_transfer();
            ...
            $id = $table_id;
             echo '   <div class="column">';
              ...
              if($table_status == 'Occupied'){
                      ...
                      <img src="../../images/table2.png" alt="table" style="width:100%; max-height:180px;">
                      <br>
                      <br>';
                      ...
                      <div>
                        ...
                        <p style="color:green; padding-top:8px;" >
                          ...
                          <br>
                          <br>
                         <a style="color: black;" class="btn btn-block btn-outline-warning transfer_object" transfer_id='.$id.' temp_id='.$t_id.'><i class="fas fa-exchange-alt"></i> Transfer Table</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel2">Transfer table?</h5>
...
function SidebarCollapse () {
    ...
    $('#collapse-icon').toggleClass('fa-angle-double-left fa-angle-double-right');
         ...
         $(document).on('click','.transfer_object',function(){
    var transfer_id = $(this).attr('transfer_id');
    var temp_id = $(this).attr('temp_id');
    console.log(transfer_id, temp_id);

    $.ajax({
        url: 'transfer_table_order.php',
        method: 'POST',
        data:{transfer_id:transfer_id,temp_id:temp_id},
