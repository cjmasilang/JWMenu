...
<div class="form-row">
  ...
  <a style="font-size: 0.9rem;" href="take_out?t=Take-out" class="navbar-brand"><i class="fas fa-arrow-circle-left"></i> Menu</a>
    <a ></a>
...
if (isset($_POST["submit"])) {
  ...
  $pusher2 = new Pusher\Pusher(
    ...
    $transaction_num = substr(sha1(mt_rand()),17,11); 
    $user->transaction_number = $transaction_num;
    $transac = $transaction_num;
    $table_id = $_POST["table_id"];
    $transaction_total_price = $_POST["transaction_total_price"]; 

    if( $user->add_transaction() && $user->update_transaction_order() && $user->update_transaction_order_add_on()){
