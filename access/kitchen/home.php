      ...
      <div class="form-row">
        ...
        extract($row2);
             ...
             echo '   <div class="column">
                   ...
                   $stmt3= $user->view_order_queue_items();
...
echo'
         ...
         <hr>
                       ';
                       $user->transaction_number = $transaction_number;
                   $stmt4= $user->view_order_queue_items_add_on();
                  ...
                  echo '  
                   ...
                   if($trans_order == 0){
                    ...
                    echo'
                       <div class="col-md-8"><span class="badge badge-danger">New</span>'.$add_on_name.'</div>
                    <div class="col-md-4">x '.$quantity.'</div>';
...
function SidebarCollapse () {
 ...
 // Enable pusher logging - don't include this in production
    ...
    $("#result").html(result);
      ...
      var channel2 = pusher.subscribe('my-channel5');
    channel2.bind('my-event5', function(data) {
  ...
  function playAudio() {
      var x = new Audio('../../sound/alert.mp3');
      x.play();
  }
